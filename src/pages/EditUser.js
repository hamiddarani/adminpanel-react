...
const EditUser = () => {
    ...
    useEffect(() => {
        dispath(fetchUser(params.id))
    } , [])
    return (
        <>
            <h1 className="text-2xl mt-4 lg:px-4">ویراش کاربر</h1>
            <div className="lg:px-4 flex flex-wrap mt-4">
                <Formik
                    enableReinitialize = {true}
                    initialValues={{name : userData.name , email : userData.email , password : "" , confirmPassword : "" , role : "", status : ""}}
                       ...
                       <>
                            ...
                            <div className="flex-col w-full md:w-1/2 lg:w-1/3 xl:w-1/4">
                                <div className="w-full flex flex-col px-4 mb-2">
                                    ...
                                    <input name="password" value={userData.password} className="w-full h-full focus:outline-none focus:ring-4 focus:ring-indigo-500 focus:ring-opacity-50 py-2 px-4 rounded-lg placeholder-gray-500" placeholder="کلمه عبور را وارد کنید" onChange={handleChange("password")}  onBlur={() => setFieldTouched('password')}/>
                                </div>
                            ...
                            <div className="flex-col w-full md:w-1/2 lg:w-1/3 xl:w-1/4">
                                <div className="w-full flex flex-col px-4 mb-4">
                                    ...
                                    <input name="confirmPassword" value={userData.confirmPassword} className="w-full h-full focus:outline-none focus:ring-4 focus:ring-indigo-500 focus:ring-opacity-50 py-2 px-4 rounded-lg placeholder-gray-500" placeholder=" تکرار کلمه عبور را وارد کنید" onChange={handleChange("confirmPassword")}  onBlur={() => setFieldTouched('confirmPassword')}/>
                                </div>
                            ...
                            <div className="flex-col w-full md:w-1/2 lg:w-1/3 xl:w-1/4">
                                <div className="w-full flex flex-col px-4 mb-4">
                                    ...
                                    <select name="role" value={userData.role} className="w-full h-full focus:outline-none focus:ring-4 focus:ring-indigo-500 focus:ring-opacity-50 py-2 px-4 rounded-lg placeholder-gray-500" onChange={handleChange("role")}  onBlur={() => setFieldTouched('role')}>
                            ...
                            <div className="flex-col w-full md:w-1/2 lg:w-1/3 xl:w-1/4">
                                <div className="w-full flex flex-col px-4 mb-4">
                                    ...
                                    <select name="status" value={userData.status} className="w-full h-full focus:outline-none focus:ring-4 focus:ring-indigo-500 focus:ring-opacity-50 py-2 px-4 rounded-lg placeholder-gray-500" onChange={handleChange("status")}  onBlur={() => setFieldTouched('status')}>
                           ...
                           <div className="flex justify-end w-full mt-2 gap-2">
                               ...
                               <button type="submit" className="bg-gradient-to-br from-blue-400 to-blue-700 px-4 py-2 text-white rounded" onClick={handleSubmit}>ویرایش کاربر</button>
                           </div>
                      </>
                   )}
                </Formik>
